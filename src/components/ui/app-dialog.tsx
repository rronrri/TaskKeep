  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className={`fixed left-1/2 top-1/2 z-50 max-h-[94vh] w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 rounded-[10px] border border-[var(--line)] bg-[var(--surface)] p-4 shadow-2xl sm:p-6 animate-[dialog-in_180ms_ease-out] ${scrollable ? "overflow-y-auto" : "overflow-hidden"} ${width}`}>
