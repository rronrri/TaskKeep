...
- Sin carpeta raíz que configurar aparte: cada tarea genera automáticamente su carpeta `AAAA-MM-DD - título` directo en "Mi unidad" de quien la posee, y se puede elegir otra carpeta por tarea con el selector de Google. Borrar archivos o la tarea completa nunca borra esa carpeta en Drive.
